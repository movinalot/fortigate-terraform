locals {
  ...
  resource_group_name     = "fortigate_active_active_ipsec"
  resource_group_location = "centralus"

  virtual_network_name          = "vnet_security"
  virtual_network_address_space = ["10.225.0.0/16"]

  fortigate_1_license_file = ""
  fortigate_2_license_file = ""

  # FortiGate Licese files are expected to be in the same
  # folder as this file, when using byol

  # fortigate_1_license_file = "FGVM4VTM22001098.lic"
  # fortigate_2_license_file = "FGVM4VTM22001099.lic"
  ...
  vm_image = {
    "fortigate" = {
      ...
      sku          = "fortinet_fg-vm_payg_2022" # byol and flex use: fortinet_fg-vm | payg use: fortinet_fg-vm_payg_2022
  ...
  subnets = {
    "external" = {
      ...
      address_prefixes = [cidrsubnet(module.module_azurerm_virtual_network[local.virtual_network_name].virtual_network.address_space[0], 8, 0)]
    }
    "internal" = {
      resource_group_name = module.module_azurerm_resource_group[local.resource_group_name].resource_group.name
      ...
      name             = "internal"
      vnet_name        = local.virtual_network_name
      address_prefixes = [cidrsubnet(module.module_azurerm_virtual_network[local.virtual_network_name].virtual_network.address_space[0], 8, 1)]
    }
    "protected" = {
      resource_group_name = module.module_azurerm_resource_group[local.resource_group_name].resource_group.name
      ...
      name             = "protected"
      vnet_name        = local.virtual_network_name
      address_prefixes = [cidrsubnet(module.module_azurerm_virtual_network[local.virtual_network_name].virtual_network.address_space[0], 8, 2)]
    }
  }
