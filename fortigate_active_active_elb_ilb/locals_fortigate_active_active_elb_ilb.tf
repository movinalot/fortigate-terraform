locals {
  ...
  resource_group_name     = "rg-fortigate_aa_elb_ilb"
  ...
  virtual_machines = {
    ...
    "vm_fgt_2" = {
      ...
      network_interface_ids        = [for nic in ["nic-fortigate_2_1", "nic-fortigate_2_2"] : azurerm_network_interface.network_interface[nic].id]
